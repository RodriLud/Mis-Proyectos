...
<body>
	<div class="container mt-5">
		<div class="card mx-auto text-center" style="max-width: 600px;">
			<img
				src="https://m.media-amazon.com/images/I/61jAgIKMdxL._AC_SX466_.jpg"
				class="card-img-top mx-auto d-block" alt="Televisor LED"
				style="max-width: 100%; height: auto; max-height: 300px; object-fit: contain;">
			<div class="card-body text-center">
				<h3 class="card-title">Silla de Oficina</h3>
				<p class="card-text">Descripción: Silla ergonómica con soporte
					lumbar ajustable.</p>
				<p class="card-text font-weight-bold">Precio: $500,00</p>
